    ...
    return (
        <div>
            <div className="relative bg-white">
                ...
                <div
                    className={`${hamburger ? 'opacity-0 scale-95' : 'opacity-100 scale-100'} duration-200 ease-out absolute top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden`}>
                    <div
